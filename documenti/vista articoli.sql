...
dbo.artico.ar_unmis AS UM, dbo.artico.ar_hhcodhhwb AS ID_Prodotto, dbo.artico.ar_hhvarwb AS ID_variante,dbo.artico.ar_hhdeshhwb AS Descr_web, dbo.artico.ar_hhpesotassabile AS pesotassabile,
ISNULL(listini.lc_prezzo, 0) AS Prezzo, ISNULL(listini.lc_prezzo, 0) PrezzoNoIva,22 as Iva, ISNULL(artpro.ap_esist - artpro.ap_impeg, 0) AS Dispnetta,
dbo.artico.ar_qtacon2 AS Pack, dbo.artico.ar_hhnomeprodotto AS Prodotto, tabhhca.tb_deshhca AS Colore, dbo.artico.ar_hhqtacon4 AS Formato,
